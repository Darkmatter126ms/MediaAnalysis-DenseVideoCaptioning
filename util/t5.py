...
def create_sentinel_ids(mask_indices: np.ndarray, tokenizer, num_bins: int) -> np.ndarray:
    """
...
def filter_input_ids(input_ids: np.ndarray, sentinel_ids: np.ndarray, tokenizer) -> np.ndarray:
    """
